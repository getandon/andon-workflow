    ...
    schema: {
      ...
      output: {
        ...
        properties: {
          ...
          ordersTotal: { type: 'number', title: 'Orders Total' },
          ordersCompleted: { type: 'number', title: 'Orders Completed' },
          ordersSkippedStatus: { type: 'number', title: 'Orders Skipped (Status)' },
          ordersSkippedCategory: { type: 'number', title: 'Orders Skipped (Category)' },
